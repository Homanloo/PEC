...
### All the blocks are defined based on the bublP flowchart.
...
def bubble_P(components, T, z, eos_model):
    ...
    # If the algorithm strugles with a pressure value, sometimes trying extremely higher or lower
    # pressures can be helpful.    
